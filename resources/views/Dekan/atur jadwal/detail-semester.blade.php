...
<div class="sub-columns d-flex flex-column flex-md-row justify-content-between" style="padding-left: 5%; height: 30%;">
    ...
    <div class="flex-column justify-content-center align-items-start" style="margin-right: 3%; height: 100%; width: 100%;" >
        ...
        <div class="row d-flex justify-content-between row-overflow" style="width: 100%; background-color: #B5A3C6; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
            ...
            <div class="d-flex align-items-start" style="margin-top: 3%">
            ...
            <div class="d-flex align-items-start" style="margin-bottom: 3%;">
                <div class="text-white" style="background-color: #775E90; border-radius: 50%; padding: 15px 22px; text-align: center;">
                    D
                </div>
                <div class="d-flex flex-column mx-3" style="width: 100%;">
                    <div class="course-item mb-2" style="background-color: #F1DEDD; border-radius: 10px; padding: 10px;">
                        <strong>Kamis</strong><br>
                        07:00 - 09:40<br>
                        E101
                    </div>
                </div>
        ...
        <div class="row d-flex justify-content-start mt-2" style="height: 15%">
            <div class="col p-0 d-flex align-items-center">
                <button class="btn btn-terima-sm-2 me-1" style="height: 100%">Terima</button>
                <button class="btn btn-tolak-sm-2 me-1" style="height: 100%">Tolak</button>
                <button class="btn btn-refresh-sm-2" style="height: 100%">
