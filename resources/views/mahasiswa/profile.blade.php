    ...
    <div class="row g-0">
        ...
        <div class="col col-sm-12 col-md-10 col-lg-10 d-flex flex-column justify-content-start p-2 pt-3">
            ...
            <div class="profile-container">
                <!-- Profile Title -->
                <h2 class="profile-header">Mahasiswa</h2>
                
                <div class="profile-content">
                    <!-- Profile Image -->
                    <div>
                        <img src="{{ asset('img/editprofil.png') }}" alt="Profile Picture" class="profile-img">
                    </div>
                    ...
                    <div class="profile-info">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <div class="profile-name">Nama Mahasiswa</div>
                        ...
                        <div class="profile-row">
                            ...
                            <div class="profile-value">youremail@undip.id</div>
                        </div>
                        <div class="profile-row">
                ...
                <div class="d-flex justify-content-end mt-3">
                    <a href="{{ route('editprofil') }}" class="edit-button">Edit</a>
                </div>
            </div>
        </div>
    </div>
