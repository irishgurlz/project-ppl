...
<div class="bg-white p-3" style="height:100%; width:100%; border-radius:15px;">
                ...
                <div>
                    ...
                    <div type="button" class="sideOp">
                     ...
                     <a href="/notifikasi" class="nav-link"> <!-- Perbaikan di sini -->
                    <div type="button" class="sideOp">
                        <div>
                            <img src="img/notifikasi.png" class="side-logo me-3">Notifikasi
                        </div>
                    </div>
                    </a>
                    ...
                    <a  href="/mahasiswa/irs" class="nav-link">
                        <div type="button" class="sideOp">
                            <div>
                                <img src="img/irs.png" class="side-logo me-3">IRS
                            </div>
                        </div>
                    </a>
                    <a  href="/khs" class="nav-link">
                        <div type="button" class="sideOp">
                            <div>
                                <img src="img/khs.png" class="side-logo me-3">KHS
                            </div>
                        </div>
                    </a>
                    <a  href="/jadwal" class="nav-link">
                        <div type="button" class="sideOp">
                            <div>
                                <img src="img/jadwal.png" class="side-logo me-3">Jadwal Kuliah
                            </div>
                        </div>
                    </a>
