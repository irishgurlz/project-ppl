                            ...
                            <form>
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control input-label" id="nama" value="Farisah Ghassani Hasyati" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="alamat" class="form-label">Alamat</label>
                                        <input type="text" class="form-control input-label" id="alamat" value="Griya Mulawarman " required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control input-label" id="email" value="farisahGhasani@undip.id" required>
                                    </div>
                                </div>
