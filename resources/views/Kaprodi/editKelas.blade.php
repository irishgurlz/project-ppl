...
<main class="container-fluid my-0 p-0"> 
    <div class="row g-0">
        ...
        <form action="/kaprodi/aturJadwal/{{$jadwal->id}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-sm-10">
                    <select name="jenis_semester" class="form-select" id="jenis_semester" >
                        <option value="" disabled value="{{ old('jenis_semester', $jadwal->jenis_semester) === null ? 'selected' : '' }}">--Pilih Jenis--</option>
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-sm-10">
                    <input type="text" name="kelas_matkul" class="form-control" id="kelas_matkul" placeholder="Masukkan hanya huruf" value="{{ old('kelas_matkul', $jadwal->kelas_matkul) }}">
                    @error('kelas_matkul')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-sm-10">
                    <select name="hari" class="form-select" id="selectDay">
                        <option value="" disabled {{ old('hari', $jadwal->hari) === null ? 'selected' : '' }}>--Pilih Hari--</option>
           ...
           <!-- SKS (Credit Hours) - Automatically filled -->
            ...
            <div class="row mb-3 d-flex justify-content-between">
                {{-- <div style="width:50%"> --}}
                    <div class="d-flex justify-content-between"  style="width:58%">
                        ...
                        <input type="time" name="jam_mulai" class="form-control" id="jam_mulai" onchange="calculateEndTime()" style="width:70%;" value="{{ old('jam_mulai', $jadwal->jam_mulai) }}">
                        @error('jam_mulai')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                {{-- <div style="width: 50%">                     --}}
                    <div class="d-flex justify-content-between" style="width:42%">
                        ...
                        <input type="text" name="jam_selesai" class="form-control" id="jam_selesai" style="width:70%"  value="{{ old('jam_selesai', $endTimeFormatted ) }}" readonly>
                    </div>
                {{-- </div> --}}
            </div>
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-sm-10">
                    <input type="number" name="kuota" class="form-control" id="kuota" min="1" value="{{ old('kuota', $jadwal->kuota) }}">
                    @error('kuota')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-sm-10">
                    <select name="id_ruang" class="form-select" id="id_ruang">
                        <option value="" disabled value="{{ old('id_ruang', $jadwal->id_ruang) }}">--Pilih Ruang--</option>
