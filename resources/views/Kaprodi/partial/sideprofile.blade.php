...
<div class="text-black bg-white pt-3" style="width:100%; height:40%; border-radius: 15px; margin: 0;text-align:center;">
    ...
    <span class="badge rounded-pill bg-secondary mt-3">Kaprodi</span>
    <h5 class="card-title" style="font-weight: bold;">Prof. Dr. Sabrina, S.Kom., M.Kom.</h5>
    ...
    <div class="d-flex justify-content-center">
        {{-- <div class="ms-auto "> --}}
            <a href="" class="btn btn-details mt-4">Details</a>
        {{-- </div> --}}
    </div>
</div>
