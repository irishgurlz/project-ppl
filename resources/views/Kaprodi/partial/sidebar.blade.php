    ...
    <div class="bg-white p-3" style="height:100%; width:16%; border-radius:15px; position: fixed" >
        ...
        <div>
            ...
            <a href="/kaprodi/dashboard" class="nav-link">
                <div class="sideOp {{ Request::is('kaprodi/dashboard') ? 'active' : '' }} d-flex align-items-center">
            ...
            <a href="/kaprodi/profile" class="nav-link">
                <div class="sideOp d-flex align-items-center">
                    <img src="{{ asset('img/users.png')}}" class="side-logo me-3 {{ Request::is('kaprodi/profile') ? 'active' : '' }}" alt="Profile Icon">Profile
                </div>
            </a>
            <!-- Link menuju Verifikasi IRS -->
            <a href="/kaprodi/verifikasiIRS" class="nav-link">
                <div class="sideOp {{ Request::is('kaprodi/verifikasiIRS') ? 'active' : '' }} d-flex align-items-center">
            ...
            <a href="/kaprodi/aturJadwal" class="nav-link">
                <div class="sideOp {{ (Request::is('kaprodi/aturJadwal')|| Request::is('kaprodi/aturJadwal/*') || Request::is('kaprodi/aturJadwal/*')) ? 'active' : '' }} d-flex align-items-center">
            ...
            <a href="/kaprodi/mata_kuliah" class="nav-link">
                <div class="sideOp {{ (Request::is('kaprodi/mata_kuliah')|| Request::is('kaprodi/mata_kuliah/*') || Request::is('kaprodi/mata_kuliah/*')) ? 'active' : '' }}  d-flex align-items-center">
