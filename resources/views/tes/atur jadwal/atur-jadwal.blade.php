...
<main class="container-fluid my-0 p-0">
    <div class="row g-0">
        ...
        <!-- Kolom 2 -->
        <div class="col col-sm-9 col-md-6 col-lg-10 d-flex flex-column justify-content-start p-2 pt-3">
            ...
            <div class="bg-white column-title d-flex justify-content-between" style="width:100%; height: 100%; border-radius: 15px; margin: 0; position: relative;">
                <div style="width: 100%; height: 785px; border-radius: 15px; background-color: white; padding:auto;">
                    @yield('content')
                </div>
            </div> 
